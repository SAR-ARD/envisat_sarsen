...
input_path: str = (
    "C:/Users/peran/CGI/SAR/input/"
    "resources_ASA_IMS_1PNESA20040109_194924_000000182023_00157_09730_0000.N1"
)
...
gtc = sarsen.envisat_terrain_correction(
    product, dem_urlpath=srtm_dem, layers_urlpath="layers.tif"
)
